import styles from '../Content/Body/Imags/image.module.css';

export function Icon_b() {
  return (
    <div>
      <svg className={styles.heart_svg} width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
